...
# for i,row in enumerate(poster_images):  # Path to the first image.
#     print('%d %s' % (i, row))
...
cv2.rectangle(image_modified, (50, 175), (120, 230), (59, 59, 255))
...
features_distance_metrics = {
    ...
    'intersection_area': intersection_area,  # NB: this is a similarity metric.
...
# 
# **Distances between two entries in the dissimilarity matrix.**
#%% [markdown]
...
final_reference_image_index = 243
...
final_scores_sorted_indexes = [0, 1, 2, 3, 4, 5]
